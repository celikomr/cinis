...
public partial class DapperExtensions
{
    ...
    public async Task ReadAsync_ById()
    {
        ...
        try
        {
            var posts = await connection.ReadAsync<Post>(7);
    ...
    public async void DeleteAsync_ById()
    {
        ...
        try
        {
            await connection.DeleteAsync<Post>(4); // dynamic id = '1000001633'
        }
        catch (Exception ex)
        {
            Console.WriteLine(ex.ToString());
    ...
    public async Task DeleteAsync_ByWhereClause()
    {
        ...
        try
        {
            await connection.DeleteAsync<Post>(whereClause: "id = '5'"); // Delete By WhereClause
        }
        catch (Exception ex)
        {
            Console.WriteLine(ex.ToString());
