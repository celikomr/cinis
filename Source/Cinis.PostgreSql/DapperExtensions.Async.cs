...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
    ...
    public static async Task<dynamic> DeleteAsync<T>(this NpgsqlConnection connection, dynamic? id = null, string? whereClause = null, NpgsqlTransaction? transaction = null)
    {
        if (connection is null)
        {
            throw new ArgumentNullException(nameof(connection));
